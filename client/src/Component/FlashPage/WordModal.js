...
export default function WordModal({ secion_id, setIsOpenModal }) {

    const options = ["Noun (n)", "Adjective (adj)", "Verb (v)", "Adverb (adv)", "Other (oth)"]
                        ...
                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <div className="relative p-6 text-left">
                                ...
                                <div>
                                    ...
                                    <Select name="type_of_word" options={options} required={true} />
                                    <input
                                        type="text"
                                        name="english"
                                        className="w-full px-2 py-1 border border-gray-300 rounded-sm outline-none"
